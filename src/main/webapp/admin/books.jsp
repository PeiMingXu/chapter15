...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/bootstrap.js" charset="gb2312"></script>
    <script  type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/js/pagination.js" charset="GBK"></script>
